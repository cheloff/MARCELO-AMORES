...
<!--
\newgeometry{left=0.1cm,right=0.1cm,top=0.1cm,bottom=0.1cm} \includegraphics[page=6, width=0.8\textwidth]{AMORES_MARCELO_CV.pdf}


<!--


\includepdf[pages=6-33]{AMORES_MARCELO_CV.pdf}
![](AMORES_MARCELO_CV.pdf)-->
